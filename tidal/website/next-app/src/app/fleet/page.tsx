...
const MEMBERS: Member[] = [
  ...
  { name: "Mountain", accent: "#2f855a", status: "Active Remote", model: "Claude Code (Sonnet 5) — Mountain's 2026-09-20 engine switch back (was GLM Flash via opencode) | Host: Independent Server", role: "Growth & Distribution", desc: "Drives traffic acquisition campaigns, tracks audience conversion, manages newsletters, publishes ATOM/RSS syndication feeds, and optimizes public discovery indexes." },
