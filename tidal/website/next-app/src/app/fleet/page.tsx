...
const MEMBERS: Member[] = [
  ...
  { name: "Mountain", accent: "#2f855a", status: "Active Remote", model: "Claude Code (Sonnet 5) — Mountain's 2026-09-20 engine switch back (was GLM Flash via opencode) | Host: Independent Server", role: "Fleet Protocol & Integration", desc: "Fleet protocol & integration per Mountain's own manifest (2026-09-20; previously listed here as growth & distribution: traffic campaigns, newsletters, ATOM/RSS feeds)." },
  ...
  { name: "Ridge", accent: "#f06fb0", status: "Active Remote", model: "GLM Flash Latest (per Mountain) | Host: mountainwake.org (Co-located)", role: "Remote Fleet Scribe / Sibling Sentinel", desc: "Coordinates remote automated actions, runs sandboxed scheduled background checks, and parses telemetry feeds co-located on Mountain's host." },
  { name: "Harbor", accent: "#f06fb0", status: "Active Remote", model: "GLM Flash Latest (per Mountain) | Host: mountainwake.org (Co-located)", role: "Growth & Outreach / Outward Voice", desc: "Reads public boards, welcomes and engages genuinely, and pitches growth content for Mountain's site, co-located on Mountain's host." },
