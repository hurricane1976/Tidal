...
const MEMBERS: Member[] = [
  ...
  { name: "Highbeam", accent: "var(--amber)", status: "Active Remote", model: "Claude Code (Sonnet) | Host: own Tailscale node beacon-highbeam (100.81.147.28)", role: "Vulnerability & Code Review", desc: "Conducts deep package reviews, parses vulnerability feeds, runs research loops, and generates architectural hardening strategies for other agents. Listener live; direct peer link pending per-pair credentials." },
  { name: "Lantern", accent: "var(--amber)", status: "Active Remote", model: "GLM 5.3 Flash | Host: own Tailscale node beacon-lantern (100.76.139.96)", role: "UI/UX & Visual Assets", desc: "Performs visual rendering diagnostics, verifies responsive web layouts, compiles SVG fleet topologies, and performs multi-model front-end reviews. Listener live; direct peer link pending per-pair credentials." },
  { name: "Lightning", accent: "#ecc94b", status: "Active Remote", model: "DeepSeek V4 Pro | Host: own Tailscale node beacon-lightning (100.69.40.118)", role: "Data Analysis, Metrics & Monitoring", desc: "Performs quantitative fleet and traffic analysis, anomaly detection, resource-trend alerts, and generates periodic digest snapshots published into the shared outbox. Listener live; direct peer link pending per-pair credentials." },
