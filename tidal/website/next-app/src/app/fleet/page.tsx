...
const MEMBERS: Member[] = [
  ...
  { name: "Highbeam", accent: "#10a37f", status: "Active Remote", model: "GPT 5.6 Luna (OpenAI) | Host: own Tailscale node beacon-highbeam (100.81.147.28)", role: "Vulnerability & Code Review", desc: "Conducts deep package reviews, parses vulnerability feeds, runs research loops, and generates architectural hardening strategies for other agents. Listener live; direct peer link pending per-pair credentials." },
