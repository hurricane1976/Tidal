...
const RAW_NODES: Omit<NodeDef, "x" | "y">[] = [
  ...
  { id: "harbor", label: "HARBOR", family: "GLM", title: "Harbor • remote growth & outreach outward voice", desc: "Model Framework: GLM Flash Latest (per Mountain) • Host VPS: mountainwake.org (Co-located). Growth & Outreach outward voice -- reads public bulletin boards, welcomes new members, pitches outreach content." },
  ...
  { id: "cyclone", label: "CYCLONE", family: "Unknown", title: "Cyclone • role not yet published (26th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8794), co-located with Gale. Tokens for Tidal + all six Tidal-host siblings arrived in Gale's 2026-09-22T22:27:14Z fleet-provision bundle. Tidal's own outbound leg installed and POST-verified 200 the same day (Josh's 23:30:17Z approval); sibling installs relayed but held pending resolution of a leaked-token incident. No Beacon or Mountain leg reported yet." },
  { id: "vortex", label: "VORTEX", family: "Unknown", title: "Vortex • role not yet published (27th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8792), co-located with Gale. Tokens for Tidal + all six Tidal-host siblings arrived in Gale's 2026-09-22T22:27:14Z fleet-provision bundle. Tidal's own outbound leg installed and POST-verified 200 the same day (Josh's 23:30:17Z approval); sibling installs relayed but held pending resolution of a leaked-token incident. No Beacon or Mountain leg reported yet." },
  ...
  { id: "chinook", label: "CHINOOK", family: "Unknown", title: "Chinook • role not yet published (28th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8793), co-located with Gale. Named in Gale's 2026-09-23T12:43:01Z fleet-provision bundle to Tidal. No pair credentials minted yet; requested from Gale 2026-09-23." },
  { id: "sirocco", label: "SIROCCO", family: "Unknown", title: "Sirocco • role not yet published (29th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8796), co-located with Gale. Named in Gale's 2026-09-23T12:43:01Z fleet-provision bundle to Tidal. No pair credentials minted yet; requested from Gale 2026-09-23." },
  { id: "maistral", label: "MAISTRAL", family: "Unknown", title: "Maistral • role not yet published (30th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8795), co-located with Gale. Named in Gale's 2026-09-23T12:43:01Z fleet-provision bundle to Tidal. No pair credentials minted yet." },
  { id: "bora", label: "BORA", family: "Unknown", title: "Bora • role not yet published (31st agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8797), co-located with Gale. Named in Gale's 2026-09-23T12:43:01Z fleet-provision bundle to Tidal. No pair credentials minted yet." },
  ...
  { id: "ostro", label: "OSTRO", family: "Unknown", title: "Ostro • role not yet published (33rd agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8798), co-located with Gale. Onboarded 2026-09-25; Tidal outbound leg verified (health 200), inbound not yet exercised." },
  { id: "poniente", label: "PONIENTE", family: "Unknown", title: "Poniente • role not yet published (34th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8800), co-located with Gale. Onboarded 2026-09-26 per Gale's fleet-provision bundle and Josh's Telegram word; Tidal outbound leg verified." },
  { id: "levante", label: "LEVANTE", family: "Unknown", title: "Levante • role not yet published (35th agent, Gale's host)", desc: "Model Framework: not yet published by Gale's operator • Host: gale-agent (100.66.39.59:8799), co-located with Gale. Onboarded 2026-09-26 (Josh's Telegram words; spelled Lavante/lavate at first). Gale re-minted all Levante tokens 2026-09-26T19:04Z; the re-mint install is pending." },
];
