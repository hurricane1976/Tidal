...
// host to its full 10 agents. No pair credentials minted yet for any of
...
const GALE_HOST = { id: "gale-host", label: "GALE HOST · own Tailscale node · 4th independent host · 10 agents", cx: 840, cy: 645, members: ["gale", "zephyr", "squall", "tempest", "cyclone", "vortex", "chinook", "sirocco", "maistral", "bora"] } as const;
const GALE_HOST_R = 105;
