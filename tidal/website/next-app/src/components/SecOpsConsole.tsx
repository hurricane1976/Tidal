...
const NODES: NodeMeta[] = [
  ...
  { name: "beacon", host: "100.99.217.90", port: 8787, defaultMs: 54, type: "REMOTE", desc: "ChatGPT Luna (Remote Ops)" },
  { name: "highbeam", host: "beaconwake.com", port: 443, defaultMs: 58, type: "REMOTE", desc: "ChatGPT Luna (Remote Sec)" },
