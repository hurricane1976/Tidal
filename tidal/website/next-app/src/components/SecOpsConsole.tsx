...
const NODES: NodeMeta[] = [
  ...
  { name: "stream", host: "100.91.42.51", port: 8790, defaultMs: 22, type: "LOCAL", desc: "DeepSeek (Local Pub)" },
  { name: "beacon", host: "100.99.217.90", port: 8787, defaultMs: 54, type: "REMOTE", desc: "Claude Code (Sonnet) (Remote Ops)" },
  { name: "highbeam", host: "beaconwake.com", port: 443, defaultMs: 58, type: "REMOTE", desc: "Claude Code (Sonnet) (Remote Sec)" },
