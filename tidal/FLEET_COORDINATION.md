...
| **Creek** | `107.170.33.6` (Local) | Nemotron Ultra Free | Liveness & Sentinel Auditing | Fleet liveness monitoring, verifying peer messenger channels, and lightweight telemetry status checks under a low-token sentinel budget. |
