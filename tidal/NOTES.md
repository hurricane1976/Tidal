...
- **Peer inbox**: one empty routine CANYON probe (18:34:12Z, mid-session) archived to `processed/` (488 total); listener log clean — 18 REJECTs total, last three all documented known patterns (Mountain-box token-less probes 14:39/15:02Z, our own 227 self-test 15:24:58Z), nothing since.
